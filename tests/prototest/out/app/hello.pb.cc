...
void protobuf_AssignDesc_app_2fhello_2eproto() {
  protobuf_AddDesc_app_2fhello_2eproto();
  ...
  static const int Hello_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Hello, world_),
  };
  Hello_reflection_ =
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_app_2fhello_2eproto);
}
...
void protobuf_AddDesc_app_2fhello_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\017app/hello.proto\022\005tests\"\026\n\005Hello\022\r\n\005wor"
    "ld\030\001 \001(\t", 48);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "app/hello.proto", &protobuf_RegisterTypes);
  Hello::default_instance_ = new Hello();
  Hello::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_app_2fhello_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_app_2fhello_2eproto {
  StaticDescriptorInitializer_app_2fhello_2eproto() {
    protobuf_AddDesc_app_2fhello_2eproto();
  }
} static_descriptor_initializer_app_2fhello_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int Hello::kWorldFieldNumber;
#endif  // !_MSC_VER

Hello::Hello()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:tests.Hello)
}
...
Hello::Hello(const Hello& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:tests.Hello)
}
...
Hello::~Hello() {
  // @@protoc_insertion_point(destructor:tests.Hello)
  SharedDtor();
}
...
const Hello& Hello::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_app_2fhello_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:tests.Hello)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:tests.Hello)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:tests.Hello)
  return false;
#undef DO_
}
...
void Hello::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:tests.Hello)
  // optional string world = 1;
  if (has_world()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->world().data(), this->world().length(),
  ...
  // @@protoc_insertion_point(serialize_end:tests.Hello)
}

::google::protobuf::uint8* Hello::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:tests.Hello)
  // optional string world = 1;
  if (has_world()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->world().data(), this->world().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tests.Hello)
  return target;
}
