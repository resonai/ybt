...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='app/hello.proto',
  package='tests',
  serialized_pb=_b('\n\x0f\x61pp/hello.proto\x12\x05tests\"\x16\n\x05Hello\x12\r\n\x05world\x18\x01 \x01(\t')
)
...
_HELLO = _descriptor.Descriptor(
  name='Hello',
  full_name='tests.Hello',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='world', full_name='tests.Hello.world', index=0,
